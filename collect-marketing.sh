...
#   - Navbar (1 file)
#   - Learn Page (1 file)          ← BARU
#   - Roadmap Page (1 file)        ← BARU
#
# Total: 14 files
...
# ============================================
# D. LEARN & ROADMAP PAGES (2 files) ← BARU
# ============================================
echo "" >> "$OUTPUT"
echo "## D. LEARN & ROADMAP PAGES (2 files)" >> "$OUTPUT"
echo "" >> "$OUTPUT"
...
for FILE in "${FILES_LEARN_ROADMAP[@]}"; do
  if [ -f "$FILE" ]; then
    echo "📄 $FILE"
    {
      echo ""
...
echo "   - Navbar: 1 file"
echo "   - Learn Page: 1 file"
echo "   - Roadmap Page: 1 file"
echo ""
echo "📌 Total: 14 marketing files"