...
//
// [PHASE C FIX]
// Prop normalized: onChange → onUpdate (match wizard call site)
// At least 1 social link required to proceed.
// ============================================================================
...
export function StepSocial({ socialLinks, onUpdate }: StepSocialProps) {
  ...
  const handleChange = (key: keyof SocialLinks, value: string) => {
    onUpdate({ ...socialLinks, [key]: value || undefined });
  };
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      {/* Status pill */}
      <div className="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium border">
        {filledCount > 0 ? (
